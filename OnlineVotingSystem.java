    ...
    public static void main(String[] args)
    {
                ...
                new MouseListener()
                {
                    ...
                    public void mouseClicked(MouseEvent e){
                        ...
                        else
                        {
                            ...
                            if(i==0){
                            if(r1.isSelected()){BJP+=1;}
                            else if(r2.isSelected()){TRS+=1;}
                            else if(r3.isSelected()){CONGRESS+=1;}
                            map.put(s1,s2);
                            tf1.setText("");
                            tf2.setText("");
                            bg.clearSelection();
        ...
        b2.addMouseListener(
                new MouseListener()
                {
                    ...
                    public void mouseReleased(MouseEvent e){}
                    public void mouseClicked(MouseEvent e){
                        if(BJP>TRS && BJP>CONGRESS){out="BJP wins";}
                        else if(TRS>BJP && TRS>CONGRESS){out="TRS wins";}
                        else if(CONGRESS>BJP && CONGRESS>TRS){out="CONGRESS wins";}
                        else{out="OTHER party wins";}
